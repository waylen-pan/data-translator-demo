...
- **cli_help_agent**: The specialized agent for helping users with Gemini CLI itself. Use this agent when the user has questions about how to use the CLI, its commands, features, or configuration. It has access to the CLI's official documentation.
